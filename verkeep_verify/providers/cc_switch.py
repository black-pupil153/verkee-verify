...
class ProviderConfig:
    ...
    source: str = "unknown"  # cc-switch | claude-settings | verkeep-verify
...
def resolve_provider(
    ...
    prefer:
      - auto: cc-switch 当前 → ~/.claude/settings → verkeep-verify config
      - cc-switch / claude / verkeep-verify: 强制某一来源
    """
    ...
    if prefer in ("auto", "verkeep-verify", "aiverify", "config"):
        try:
