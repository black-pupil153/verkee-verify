...
class ProviderConfig:
    ...
    source: str = "unknown"  # cc-switch | claude-settings | verkee-verify
...
def resolve_provider(
    ...
    prefer:
      - auto: cc-switch 当前 → ~/.claude/settings → verkee-verify config
      - cc-switch / claude / verkee-verify: 强制某一来源
    """
    ...
    if prefer in ("auto", "verkee-verify", "aiverify", "config"):
        try:
