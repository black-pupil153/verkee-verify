...
from verkeep_verify.blindtest.corpus import DEFAULT_BLINDTEST_DIR, Corpus, CorpusSample
...
def apply_channels_to_samples(
    ...
    """返回特征按通道过滤后的样本副本。"""
    from verkeep_verify.blindtest.features import filter_features_by_channels
