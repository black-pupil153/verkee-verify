...
from verkee_verify.blindtest.corpus import CorpusSample
...
def test_pure_python_nb_fallback(monkeypatch):
    ...
    import verkee_verify.blindtest.classifier as mod
...
def test_predict_turn_near_gate_and_persist(tmp_path):
    from verkee_verify.blindtest.classifier import ABSTAIN_NEAR_MARGIN
