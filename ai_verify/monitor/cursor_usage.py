...
from ai_verify.cursor_hook_events import default_hook_event_paths, read_hook_events
from ai_verify.cursor_logs import read_log_events
...
def cursor_usage_insights(period: "PeriodUsageReport") -> List[str]:
    ...
    if pending_pct >= 20:
        ...
        insights.append(
            f"unknown 请求占 {unknown_pct:.0f}%，可运行 ai-verify cursor import --full 补采"
        )
